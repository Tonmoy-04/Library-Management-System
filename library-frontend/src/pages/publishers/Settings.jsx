...
import { publisherAuthAPI } from '../../../services/api';
import '../Settings.css';
...
const PublisherSettings = () => {
  ...
  const loadProfile = async () => {
    try {
      setLoading(true);
      const response = await publisherAuthAPI.me();
      setProfile({
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      await publisherAuthAPI.updateProfile(profile);
  ...
  const updatePassword = async (e) => {
    ...
    try {
      ...
      await publisherAuthAPI.changePassword({
